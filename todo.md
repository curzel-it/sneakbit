...
- [x] Credits to not link to font, music and sound effects providers (the original does) — added the three credits lines from the upstream README (Filippo Vicarelli for music, SubspaceAudio for SFX, HarvettFox96 for the font).
