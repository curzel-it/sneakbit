...
const { _resolveDirectionForTesting } = await import("../js/input.js?v=20260529a");
const { setBinding, _resetBindingsForTesting } = await import("../js/keyBindings.js?v=20260529a");
const { setLocalPlayerCount } = await import("../js/coopMode.js?v=20260529a");
