...
const { _resolveDirectionForTesting } = await import("../js/input.js?v=20260531b");
const { setBinding, _resetBindingsForTesting } = await import("../js/keyBindings.js?v=20260531b");
const { setLocalPlayerCount } = await import("../js/coopMode.js?v=20260531b");
