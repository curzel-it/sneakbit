...
import { loadSpeciesData } from "../js/species.js?v=20260530a";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "../js/entityVisibility.js?v=20260530a";
import { _setCreativeModeForTesting } from "../js/creativeMode.js?v=20260530a";
