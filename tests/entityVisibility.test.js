...
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "../js/entityVisibility.js?v=20260529e";
import { _setCreativeModeForTesting } from "../js/creativeMode.js?v=20260529e";
