...
import { loadSpeciesData } from "../js/species.js?v=20260529b";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "../js/entityVisibility.js?v=20260529b";
import { _setCreativeModeForTesting } from "../js/creativeMode.js?v=20260529b";
