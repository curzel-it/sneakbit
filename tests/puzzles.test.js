...
const { loadSpeciesData } = await import("../js/species.js?v=20260527");
...
const { isEntityBlocked } = await import("../js/zone.js?v=20260527");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260527");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260527");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260527");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260527");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260527");
const storage = await import("../js/storage.js?v=20260527");
const inventory = await import("../js/inventory.js?v=20260527");
