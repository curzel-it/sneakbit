...
const { isEntityBlocked } = await import("../js/zone.js?v=20260529d");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260529d");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260529d");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260529d");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260529d");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260529d");
const storage = await import("../js/storage.js?v=20260529d");
const inventory = await import("../js/inventory.js?v=20260529d");
