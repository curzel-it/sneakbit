...
const { isEntityBlocked } = await import("../js/zone.js?v=20260530g");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260530g");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260530g");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260530g");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260530g");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260530g");
const storage = await import("../js/storage.js?v=20260530g");
const inventory = await import("../js/inventory.js?v=20260530g");
