...
const { isEntityBlocked } = await import("../js/zone.js?v=20260530c");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260530c");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260530c");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260530c");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260530c");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260530c");
const storage = await import("../js/storage.js?v=20260530c");
const inventory = await import("../js/inventory.js?v=20260530c");
