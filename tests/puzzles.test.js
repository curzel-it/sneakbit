...
const { isEntityBlocked } = await import("../js/zone.js?v=20260530e");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260530e");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260530e");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260530e");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260530e");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260530e");
const storage = await import("../js/storage.js?v=20260530e");
const inventory = await import("../js/inventory.js?v=20260530e");
