...
const { isEntityBlocked } = await import("../js/zone.js?v=20260529b");
const { findPushableAt, pushOneTile, pushableRenderOffset } = await import("../js/pushables.js?v=20260529b");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260529b");
const { setupPuzzles, tickPuzzles } = await import("../js/puzzles.js?v=20260529b");
const { tryUnlockGate, findGateAt } = await import("../js/gateUnlock.js?v=20260529b");
const { isPressurePlateDown } = await import("../js/locks.js?v=20260529b");
const storage = await import("../js/storage.js?v=20260529b");
const inventory = await import("../js/inventory.js?v=20260529b");
