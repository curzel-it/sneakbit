...
const broadcaster = await import("../js/snapshotBroadcaster.js?v=20260530b");
...
const { bootstrapOnline, getNet } = await import("../js/onlineBootstrap.js?v=20260530b");
...
test("hp 0-crossing emits event:death; recovery emits event:respawn", async () => {
  const fakeNet = setupBootstrapWithFakeNet();
  const ph = await import("../js/playerHealth.js?v=20260530b");
