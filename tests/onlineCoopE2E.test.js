...
const { _setOnlineModeForTesting, _resetOnlineModeForTesting } =
  await import("../js/onlineMode.js?v=20260530c");
const { _resetOnlineBootstrapForTesting, bootstrapOnline } =
  await import("../js/onlineBootstrap.js?v=20260530c");
const { installHostGuests, _uninstallHostGuestsForTesting } =
  await import("../js/hostGuests.js?v=20260530c");
const {
  installSnapshotBroadcaster,
  stopSnapshotBroadcaster,
  _snapshotForTesting,
  _broadcastDeltaForTesting,
} = await import("../js/snapshotBroadcaster.js?v=20260530c");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260530c");
const { installShooting, tickShooting, tryShootForSlot } = await import("../js/shooting.js?v=20260530c");
const { checkPickup } = await import("../js/pickups.js?v=20260530c");
const { loadSpeciesData } = await import("../js/species.js?v=20260530c");
const { addAmmo, getAmmo, clearInventory } = await import("../js/inventory.js?v=20260530c");
const { resetPlayerHealth } = await import("../js/playerHealth.js?v=20260530c");
const { setNetworkGuestCount } = await import("../js/coopMode.js?v=20260530c");
const { _resetStorageForTesting } = await import("../js/storage.js?v=20260530c");
const inputModule = await import("../js/input.js?v=20260530c");
