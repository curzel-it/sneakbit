...
const { installHostGuests, _uninstallHostGuestsForTesting } =
  await import("../js/hostGuests.js?v=20260528g");
const {
  installSnapshotBroadcaster,
  stopSnapshotBroadcaster,
  _snapshotForTesting,
  _broadcastDeltaForTesting,
} = await import("../js/snapshotBroadcaster.js?v=20260528g");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260528g");
const { installShooting, tickShooting, tryShootForSlot } = await import("../js/shooting.js?v=20260528g");
const { checkPickup } = await import("../js/pickups.js?v=20260528g");
const { loadSpeciesData } = await import("../js/species.js?v=20260528g");
const { addAmmo, getAmmo, clearInventory } = await import("../js/inventory.js?v=20260528g");
const { resetPlayerHealth } = await import("../js/playerHealth.js?v=20260528g");
const { setNetworkGuestCount } = await import("../js/coopMode.js?v=20260528g");
