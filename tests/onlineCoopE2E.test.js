...
const { installHostGuests, _uninstallHostGuestsForTesting } =
  await import("../js/hostGuests.js?v=20260529d");
const {
  installSnapshotBroadcaster,
  stopSnapshotBroadcaster,
  _snapshotForTesting,
  _broadcastDeltaForTesting,
} = await import("../js/snapshotBroadcaster.js?v=20260529d");
const { createPlayer, updatePlayer } = await import("../js/player.js?v=20260529d");
const { installShooting, tickShooting, tryShootForSlot } = await import("../js/shooting.js?v=20260529d");
const { checkPickup } = await import("../js/pickups.js?v=20260529d");
const { loadSpeciesData } = await import("../js/species.js?v=20260529d");
const { addAmmo, getAmmo, clearInventory } = await import("../js/inventory.js?v=20260529d");
const { resetPlayerHealth } = await import("../js/playerHealth.js?v=20260529d");
const { setNetworkGuestCount } = await import("../js/coopMode.js?v=20260529d");
const { _resetStorageForTesting } = await import("../js/storage.js?v=20260529d");
const inputModule = await import("../js/input.js?v=20260529d");
