...
export async function startCoopSession({
  ...
  if (entry === "deeplink") {
    ...
    await evalExpr(guest, `
      (async () => {
        const sr = await import('./js/switchRole.js?v=20260531c');
  ...
  await waitFor(guest, `
    (async () => {
      const m = await import('./js/mirrorWorld.js?v=20260531c');
      const p = await import('./js/predictedSelf.js?v=20260531c');
      const o = await import('./js/onlineBootstrap.js?v=20260531c');
      window.__sb = { m, p, o };
