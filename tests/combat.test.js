...
import { loadSpeciesData } from "../js/species.js?v=20260528h";
...
const combat = await import("../js/combat.js?v=20260528h");
...
test("friendly fire OFF: a P1-owned bullet flying through P2 does no damage", async () => {
  ...
  const { saveSettings } = await import("../js/settings.js?v=20260528h");
