...
const playerHealth = await import("../js/playerHealth.js?v=20260531b");
...
const coopMode = await import("../js/coopMode.js?v=20260531b");
const { updateCamera, createCamera, cameraRectFor } = await import("../js/camera.js?v=20260531b");
