...
const playerHealth = await import("../js/playerHealth.js?v=20260530e");
const inventory = await import("../js/inventory.js?v=20260530e");
const equipment = await import("../js/equipment.js?v=20260530e");
const storage = await import("../js/storage.js?v=20260530e");
const coopMode = await import("../js/coopMode.js?v=20260530e");
const { updateCamera, createCamera, cameraRectFor } = await import("../js/camera.js?v=20260530e");
