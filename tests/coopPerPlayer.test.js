...
const playerHealth = await import("../js/playerHealth.js?v=20260528c");
const inventory = await import("../js/inventory.js?v=20260528c");
const equipment = await import("../js/equipment.js?v=20260528c");
const storage = await import("../js/storage.js?v=20260528c");
const coopMode = await import("../js/coopMode.js?v=20260528c");
const { updateCamera, createCamera } = await import("../js/camera.js?v=20260528c");
