...
const playerHealth = await import("../js/playerHealth.js?v=20260531a");
const inventory = await import("../js/inventory.js?v=20260531a");
const equipment = await import("../js/equipment.js?v=20260531a");
const storage = await import("../js/storage.js?v=20260531a");
const coopMode = await import("../js/coopMode.js?v=20260531a");
const { updateCamera, createCamera, cameraRectFor } = await import("../js/camera.js?v=20260531a");
