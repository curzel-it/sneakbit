    ...
    fn texture_source_rect(&self) -> IntRect {
        let (y, x) = match self {
            ...
            Stockable::ConstructionTile(construction) => match construction {
                ...
                Construction::SlopeDarkRockTopLeft => (3, 16),
                Construction::SlopeDarkRockTopRight => (3, 17),
                Construction::SlopeDarkRockBottomRight => (3, 18),
                Construction::SlopeDarkRockBottomLeft => (3, 19),
                Construction::SlopeDarkRockBottom => (3, 20),
                Construction::SlopeDarkRockTop => (3, 21),
                Construction::SlopeDarkRockLeft => (3, 22),
                Construction::SlopeDarkRockRight => (3, 23),
            },
