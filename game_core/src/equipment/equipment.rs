use crate::{constants::{PLAYER1_ENTITY_ID, TILE_SIZE}, entities::known_species::{SPECIES_CLAYMORE, SPECIES_CLAYMORE_ITEM, SPECIES_KUNAI_LAUNCHER, SPECIES_SWORD, SPECIES_SWORD_ITEM}, game_engine::{entity::Entity, state_updates::WorldStateUpdate, storage::inventory_count, world::World}};

impl Entity {
    pub fn setup_equipment(&mut self) {
        self.parent_id = PLAYER1_ENTITY_ID;
