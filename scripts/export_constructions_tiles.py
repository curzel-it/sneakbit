...
def export_constructions_tiles(aseprite_assets, destination_folder):
    os.system(f"{aseprite_path} -b {aseprite_assets}/tiles_constructions.aseprite --save-as {destination_folder}/tiles_constructions_raw.png")

os.system(f"rm -rf {pngs_folder}/tiles_constructions_raw.png")
