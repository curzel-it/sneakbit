use game_core::{input::keyboard_events_provider::KeyboardEventsProvider, hstack, lang::localizable::LocalizableText, spacing, text, ui::{components::{Spacing, Typography, View, COLOR_MENU_BACKGROUND, COLOR_TRANSPARENT}, scaffold::scaffold}, vstack, zstack};
