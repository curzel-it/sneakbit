use super::{audio::AudioManager, death_screen::DeathScreen, fast_travel::FastTravelMenu, loading_screen::LoadingScreen, pvp_arena::PvpArenaMenu};
...
impl GameContext {
    ...
    pub fn is_game_paused(&self) -> bool {
        self.pvp_arena_menu.is_open() || self.fast_travel_menu.is_open() || self.menu.is_open() || self.messages.is_open() || self.is_dead()
    }
