...
import { applyPlayerContinuousDamage, applyPlayerDamage, isPlayerDead } from "./playerHealth.js?v=20260530f";
import { hasPiercingKnifeSkill, hasBoomerangSkill, hasBulletCatcherSkill } from "./skills.js?v=20260530f";
import { addAmmo } from "./inventory.js?v=20260530f";
import { isExplosive } from "./explosives.js?v=20260530f";
import { isCreativeMode } from "./creativeMode.js?v=20260530f";
import { getSettings } from "./settings.js?v=20260530f";
import { startDeathAnimation, tickDeathAnimations } from "./deathAnimation.js?v=20260530f";
