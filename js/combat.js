...
import { isWalkable } from "./zone.js?v=20260530c";
import { playSfx } from "./audio.js?v=20260530c";
import { applyPlayerContinuousDamage, applyPlayerDamage, isPlayerDead } from "./playerHealth.js?v=20260530c";
import { hasPiercingKnifeSkill, hasBoomerangSkill, hasBulletCatcherSkill } from "./skills.js?v=20260530c";
import { addAmmo } from "./inventory.js?v=20260530c";
import { isExplosive } from "./explosives.js?v=20260530c";
import { isCreativeMode } from "./creativeMode.js?v=20260530c";
import { getSettings } from "./settings.js?v=20260530c";
import { startDeathAnimation, tickDeathAnimations } from "./deathAnimation.js?v=20260530c";
import { isPvp } from "./gameMode.js?v=20260530c";
