...
// out as a side effect, stranding the cloud save behind a re-login. A wipe
// should reset progress, not identity. captureSession() returns the serialized
// session (hydrating from storage first); restoreSession() writes it straight
// back after the clear. It's a pure storage round-trip — the in-memory session
// is irrelevant because the page reloads immediately afterward.
