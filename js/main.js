...
import { STARTING_ZONE_ID, STARTING_SPAWN, PVP_ARENA_ZONE_ID } from "./constants.js?v=20260531c";
import { loadAssets } from "./assets.js?v=20260531c";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260531c";
import { loadStringsData, tr } from "./strings.js?v=20260531c";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260531c";
import { installInteract, tickInteract, tryInteractForSlot } from "./interact.js?v=20260531c";
import { loadSpeciesData } from "./species.js?v=20260531c";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260531c";
import { buildZone } from "./zone.js?v=20260531c";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260531c";
import { initInput, pollInput, clearInputState, clearInputHeld, pushInputPress } from "./input.js?v=20260531c";
import { createPlayer, updatePlayer } from "./player.js?v=20260531c";
import { createCamera, updateCamera, panCameraTo, cameraRectFor } from "./camera.js?v=20260531c";
import { createRenderer, render } from "./renderer.js?v=20260531c";
import { startGameLoop } from "./gameLoop.js?v=20260531c";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260531c";
import { tickEntities } from "./entities.js?v=20260531c";
import { installAutoZoom } from "./zoom.js?v=20260531c";
import { installHud, updateHud } from "./hud.js?v=20260531c";
import { loadAudio } from "./audio.js?v=20260531c";
import { loadSettings, getSettings, resolveLanguage } from "./settings.js?v=20260531c";
import { installMenu, isMenuOpen } from "./menu.js?v=20260531c";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260531c";
import { checkPickup } from "./pickups.js?v=20260531c";
import { installMusic, playTrack } from "./music.js?v=20260531c";
import { installTouchControls } from "./touch.js?v=20260531c";
import { installToast, showToast } from "./toast.js?v=20260531c";
import { installShooting, tickShooting, tryShoot, tryShootForSlot } from "./shooting.js?v=20260531c";
import { installMelee, tickMelee, tryMelee, tryMeleeForSlot } from "./melee.js?v=20260531c";
import { setGamepadAction } from "./gamepad.js?v=20260531c";
import { pollGuestGamepad } from "./guestInputForwarder.js?v=20260531c";
import { installActiveInputDevice } from "./activeInputDevice.js?v=20260531c";
import { installControllerPresence, isControllerPaused } from "./controllerPresence.js?v=20260531c";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260531c";
import { tickMobs } from "./mobs.js?v=20260531c";
import { tickMonsterFusion } from "./monsters.js?v=20260531c";
import { tickMinionSpawning } from "./minions.js?v=20260531c";
import { tickCombat } from "./combat.js?v=20260531c";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260531c";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260531c";
import { installHealthHud, refreshHealthHud } from "./healthHud.js?v=20260531c";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260531c";
import { installMessage, isMessageOpen } from "./message.js?v=20260531c";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260531c";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260531c";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260531c";
import { getZoneCache } from "./zoneCache.js?v=20260531c";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260531c";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260531c";
import { tickTrails } from "./trails.js?v=20260531c";
import { tickPushables } from "./pushables.js?v=20260531c";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260531c";
import { isCoopMode, setCoopMode, setLocalPlayerCount, localPlayerCount } from "./coopMode.js?v=20260531c";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260531c";
import { runMigrations } from "./migrations.js?v=20260531c";
import { installMapEditor } from "./mapEditor.js?v=20260531c";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260531c";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260531c";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260531c";
import { tickLocalEffects } from "./localEffects.js?v=20260531c";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260531c";
import { installPartyPanel, isPartyPanelOpen } from "./partyPanel.js?v=20260531c";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260531c";
import { setHostPaused } from "./hostPauseState.js?v=20260531c";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260531c";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260531c";
import { installUiTokens } from "./uiTokens.js?v=20260531c";
import { isPvp, isTurnBasedPvp, isRealtimePvp, isPvpHostSetup } from "./gameMode.js?v=20260531c";
import { getTurn, isMatchOver } from "./pvpMatch.js?v=20260531c";
import { installTurnHud, updateTurnHud, hideTurnHud } from "./turnHud.js?v=20260531c";
import {
  installPvpController, pvpGateInput, pvpCameraTarget, tickPvpFrame,
} from "./pvpController.js?v=20260531c";
import { installOnlineDeathmatch, tickHostFrame as tickOnlineDeathmatch } from "./onlineDeathmatch.js?v=20260531c";
