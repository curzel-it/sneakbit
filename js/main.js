...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260528g";
import { loadAssets } from "./assets.js?v=20260528g";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260528g";
import { loadStringsData, tr } from "./strings.js?v=20260528g";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260528g";
import { installInteract, tickInteract } from "./interact.js?v=20260528g";
import { loadSpeciesData } from "./species.js?v=20260528g";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260528g";
import { buildZone } from "./zone.js?v=20260528g";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260528g";
import { initInput, pollInput } from "./input.js?v=20260528g";
import { createPlayer, updatePlayer } from "./player.js?v=20260528g";
import { createCamera, updateCamera } from "./camera.js?v=20260528g";
import { createRenderer, render } from "./renderer.js?v=20260528g";
import { startGameLoop } from "./gameLoop.js?v=20260528g";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260528g";
import { tickEntities } from "./entities.js?v=20260528g";
import { installAutoZoom } from "./zoom.js?v=20260528g";
import { installHud, updateHud } from "./hud.js?v=20260528g";
import { loadAudio } from "./audio.js?v=20260528g";
import { loadSettings, getSettings } from "./settings.js?v=20260528g";
import { installMenu, isMenuOpen } from "./menu.js?v=20260528g";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260528g";
import { checkPickup } from "./pickups.js?v=20260528g";
import { installMusic, playTrack } from "./music.js?v=20260528g";
import { installTouchControls } from "./touch.js?v=20260528g";
import { installToast, showToast } from "./toast.js?v=20260528g";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260528g";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260528g";
import { setGamepadAction } from "./gamepad.js?v=20260528g";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260528g";
import { tickMobs } from "./mobs.js?v=20260528g";
import { tickMonsterFusion } from "./monsters.js?v=20260528g";
import { tickMinionSpawning } from "./minions.js?v=20260528g";
import { tickCombat } from "./combat.js?v=20260528g";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260528g";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260528g";
import { installHealthHud } from "./healthHud.js?v=20260528g";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260528g";
import { installMessage, isMessageOpen } from "./message.js?v=20260528g";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260528g";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260528g";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260528g";
import { getZoneCache } from "./zoneCache.js?v=20260528g";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260528g";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260528g";
import { tickTrails } from "./trails.js?v=20260528g";
import { tickPushables } from "./pushables.js?v=20260528g";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260528g";
import { isCoopMode, setCoopMode } from "./coopMode.js?v=20260528g";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260528g";
import { runMigrations } from "./migrations.js?v=20260528g";
import { installMapEditor } from "./mapEditor.js?v=20260528g";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260528g";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260528g";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260528g";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260528g";
import { installPartyPanel } from "./partyPanel.js?v=20260528g";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260528g";
import { setHostPaused } from "./hostPauseState.js?v=20260528g";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260528g";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260528g";
import { installUiTokens } from "./uiTokens.js?v=20260528g";
