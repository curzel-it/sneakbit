...
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260530f";
import { installInteract, tickInteract, tryInteractForSlot } from "./interact.js?v=20260530f";
import { loadSpeciesData } from "./species.js?v=20260530f";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260530f";
import { buildZone } from "./zone.js?v=20260530f";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260530f";
import { initInput, pollInput, clearInputState, clearInputHeld, pushInputPress } from "./input.js?v=20260530f";
import { createPlayer, updatePlayer } from "./player.js?v=20260530f";
import { createCamera, updateCamera, panCameraTo, cameraRectFor } from "./camera.js?v=20260530f";
import { createRenderer, render } from "./renderer.js?v=20260530f";
import { startGameLoop } from "./gameLoop.js?v=20260530f";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260530f";
import { tickEntities } from "./entities.js?v=20260530f";
import { installAutoZoom } from "./zoom.js?v=20260530f";
import { installHud, updateHud } from "./hud.js?v=20260530f";
import { loadAudio } from "./audio.js?v=20260530f";
import { loadSettings, getSettings, resolveLanguage } from "./settings.js?v=20260530f";
import { installMenu, isMenuOpen } from "./menu.js?v=20260530f";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260530f";
import { checkPickup } from "./pickups.js?v=20260530f";
import { installMusic, playTrack } from "./music.js?v=20260530f";
import { installTouchControls } from "./touch.js?v=20260530f";
import { installToast, showToast } from "./toast.js?v=20260530f";
import { installShooting, tickShooting, tryShoot, tryShootForSlot } from "./shooting.js?v=20260530f";
import { installMelee, tickMelee, tryMelee, tryMeleeForSlot } from "./melee.js?v=20260530f";
import { setGamepadAction } from "./gamepad.js?v=20260530f";
import { pollGuestGamepad } from "./guestInputForwarder.js?v=20260530f";
import { installActiveInputDevice } from "./activeInputDevice.js?v=20260530f";
import { installControllerPresence, isControllerPaused } from "./controllerPresence.js?v=20260530f";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260530f";
import { tickMobs } from "./mobs.js?v=20260530f";
import { tickMonsterFusion } from "./monsters.js?v=20260530f";
import { tickMinionSpawning } from "./minions.js?v=20260530f";
import { tickCombat } from "./combat.js?v=20260530f";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260530f";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260530f";
import { installHealthHud, refreshHealthHud } from "./healthHud.js?v=20260530f";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260530f";
import { installMessage, isMessageOpen } from "./message.js?v=20260530f";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260530f";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260530f";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260530f";
import { getZoneCache } from "./zoneCache.js?v=20260530f";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260530f";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260530f";
import { tickTrails } from "./trails.js?v=20260530f";
import { tickPushables } from "./pushables.js?v=20260530f";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260530f";
import { isCoopMode, setCoopMode, setLocalPlayerCount, localPlayerCount } from "./coopMode.js?v=20260530f";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260530f";
import { runMigrations } from "./migrations.js?v=20260530f";
import { installMapEditor } from "./mapEditor.js?v=20260530f";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260530f";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260530f";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260530f";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260530f";
import { installPartyPanel, isPartyPanelOpen } from "./partyPanel.js?v=20260530f";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260530f";
import { setHostPaused } from "./hostPauseState.js?v=20260530f";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260530f";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260530f";
import { installUiTokens } from "./uiTokens.js?v=20260530f";
import { isPvp, isTurnBasedPvp, isRealtimePvp, isPvpHostSetup } from "./gameMode.js?v=20260530f";
import { getTurn, isMatchOver } from "./pvpMatch.js?v=20260530f";
import { installTurnHud, updateTurnHud, hideTurnHud } from "./turnHud.js?v=20260530f";
import {
  installPvpController, pvpGateInput, pvpCameraTarget, tickPvpFrame,
} from "./pvpController.js?v=20260530f";
import { installOnlineDeathmatch, tickHostFrame as tickOnlineDeathmatch } from "./onlineDeathmatch.js?v=20260530f";
