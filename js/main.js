...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260530d";
import { loadAssets } from "./assets.js?v=20260530d";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260530d";
import { loadStringsData, tr } from "./strings.js?v=20260530d";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260530d";
import { installInteract, tickInteract, tryInteractForSlot } from "./interact.js?v=20260530d";
import { loadSpeciesData } from "./species.js?v=20260530d";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260530d";
import { buildZone } from "./zone.js?v=20260530d";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260530d";
import { initInput, pollInput, clearInputState, clearInputHeld, pushInputPress } from "./input.js?v=20260530d";
import { createPlayer, updatePlayer } from "./player.js?v=20260530d";
import { createCamera, updateCamera, panCameraTo, cameraRectFor } from "./camera.js?v=20260530d";
import { createRenderer, render } from "./renderer.js?v=20260530d";
import { startGameLoop } from "./gameLoop.js?v=20260530d";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260530d";
import { tickEntities } from "./entities.js?v=20260530d";
import { installAutoZoom } from "./zoom.js?v=20260530d";
import { installHud, updateHud } from "./hud.js?v=20260530d";
import { loadAudio } from "./audio.js?v=20260530d";
import { loadSettings, getSettings, resolveLanguage } from "./settings.js?v=20260530d";
import { installMenu, isMenuOpen } from "./menu.js?v=20260530d";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260530d";
import { checkPickup } from "./pickups.js?v=20260530d";
import { installMusic, playTrack } from "./music.js?v=20260530d";
import { installTouchControls } from "./touch.js?v=20260530d";
import { installToast, showToast } from "./toast.js?v=20260530d";
import { installShooting, tickShooting, tryShoot, tryShootForSlot } from "./shooting.js?v=20260530d";
import { installMelee, tickMelee, tryMelee, tryMeleeForSlot } from "./melee.js?v=20260530d";
import { setGamepadAction } from "./gamepad.js?v=20260530d";
import { pollGuestGamepad } from "./guestInputForwarder.js?v=20260530d";
import { installActiveInputDevice } from "./activeInputDevice.js?v=20260530d";
import { installControllerPresence, isControllerPaused } from "./controllerPresence.js?v=20260530d";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260530d";
import { tickMobs } from "./mobs.js?v=20260530d";
import { tickMonsterFusion } from "./monsters.js?v=20260530d";
import { tickMinionSpawning } from "./minions.js?v=20260530d";
import { tickCombat } from "./combat.js?v=20260530d";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260530d";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260530d";
import { installHealthHud, refreshHealthHud } from "./healthHud.js?v=20260530d";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260530d";
import { installMessage, isMessageOpen } from "./message.js?v=20260530d";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260530d";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260530d";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260530d";
import { getZoneCache } from "./zoneCache.js?v=20260530d";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260530d";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260530d";
import { tickTrails } from "./trails.js?v=20260530d";
import { tickPushables } from "./pushables.js?v=20260530d";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260530d";
import { isCoopMode, setCoopMode, setLocalPlayerCount, localPlayerCount } from "./coopMode.js?v=20260530d";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260530d";
import { runMigrations } from "./migrations.js?v=20260530d";
import { installMapEditor } from "./mapEditor.js?v=20260530d";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260530d";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260530d";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260530d";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260530d";
import { installPartyPanel, isPartyPanelOpen } from "./partyPanel.js?v=20260530d";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260530d";
import { setHostPaused } from "./hostPauseState.js?v=20260530d";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260530d";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260530d";
import { installUiTokens } from "./uiTokens.js?v=20260530d";
import { isPvp, isTurnBasedPvp, isRealtimePvp } from "./gameMode.js?v=20260530d";
import { getTurn, isMatchOver } from "./pvpMatch.js?v=20260530d";
import { installTurnHud, updateTurnHud, hideTurnHud } from "./turnHud.js?v=20260530d";
import {
  installPvpController, pvpGateInput, pvpCameraTarget, tickPvpFrame,
} from "./pvpController.js?v=20260530d";
import { installOnlineDeathmatch, tickHostFrame as tickOnlineDeathmatch } from "./onlineDeathmatch.js?v=20260530d";
