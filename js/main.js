...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260530b";
import { loadAssets } from "./assets.js?v=20260530b";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260530b";
import { loadStringsData, tr } from "./strings.js?v=20260530b";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260530b";
import { installInteract, tickInteract, tryInteractForSlot } from "./interact.js?v=20260530b";
import { loadSpeciesData } from "./species.js?v=20260530b";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260530b";
import { buildZone } from "./zone.js?v=20260530b";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260530b";
import { initInput, pollInput, clearInputState, clearInputHeld, pushInputPress } from "./input.js?v=20260530b";
import { createPlayer, updatePlayer } from "./player.js?v=20260530b";
import { createCamera, updateCamera, panCameraTo, cameraRectFor } from "./camera.js?v=20260530b";
import { createRenderer, render } from "./renderer.js?v=20260530b";
import { startGameLoop } from "./gameLoop.js?v=20260530b";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260530b";
import { tickEntities } from "./entities.js?v=20260530b";
import { installAutoZoom } from "./zoom.js?v=20260530b";
import { installHud, updateHud } from "./hud.js?v=20260530b";
import { loadAudio } from "./audio.js?v=20260530b";
import { loadSettings, getSettings, resolveLanguage } from "./settings.js?v=20260530b";
import { installMenu, isMenuOpen } from "./menu.js?v=20260530b";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260530b";
import { checkPickup } from "./pickups.js?v=20260530b";
import { installMusic, playTrack } from "./music.js?v=20260530b";
import { installTouchControls } from "./touch.js?v=20260530b";
import { installToast, showToast } from "./toast.js?v=20260530b";
import { installShooting, tickShooting, tryShoot, tryShootForSlot } from "./shooting.js?v=20260530b";
import { installMelee, tickMelee, tryMelee, tryMeleeForSlot } from "./melee.js?v=20260530b";
import { setGamepadAction } from "./gamepad.js?v=20260530b";
import { pollGuestGamepad } from "./guestInputForwarder.js?v=20260530b";
import { installActiveInputDevice } from "./activeInputDevice.js?v=20260530b";
import { installControllerPresence, isControllerPaused } from "./controllerPresence.js?v=20260530b";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260530b";
import { tickMobs } from "./mobs.js?v=20260530b";
import { tickMonsterFusion } from "./monsters.js?v=20260530b";
import { tickMinionSpawning } from "./minions.js?v=20260530b";
import { tickCombat } from "./combat.js?v=20260530b";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260530b";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260530b";
import { installHealthHud, refreshHealthHud } from "./healthHud.js?v=20260530b";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260530b";
import { installMessage, isMessageOpen } from "./message.js?v=20260530b";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260530b";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260530b";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260530b";
import { getZoneCache } from "./zoneCache.js?v=20260530b";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260530b";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260530b";
import { tickTrails } from "./trails.js?v=20260530b";
import { tickPushables } from "./pushables.js?v=20260530b";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260530b";
import { isCoopMode, setCoopMode, setLocalPlayerCount, localPlayerCount } from "./coopMode.js?v=20260530b";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260530b";
import { runMigrations } from "./migrations.js?v=20260530b";
import { installMapEditor } from "./mapEditor.js?v=20260530b";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260530b";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260530b";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260530b";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260530b";
import { installPartyPanel, isPartyPanelOpen } from "./partyPanel.js?v=20260530b";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260530b";
import { setHostPaused } from "./hostPauseState.js?v=20260530b";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260530b";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260530b";
import { installUiTokens } from "./uiTokens.js?v=20260530b";
import { isPvp, isTurnBasedPvp, isRealtimePvp } from "./gameMode.js?v=20260530b";
import { getTurn, isMatchOver } from "./pvpMatch.js?v=20260530b";
import { installTurnHud, updateTurnHud, hideTurnHud } from "./turnHud.js?v=20260530b";
import {
  installPvpController, pvpGateInput, pvpCameraTarget, tickPvpFrame,
} from "./pvpController.js?v=20260530b";
import { installOnlineDeathmatch, tickHostFrame as tickOnlineDeathmatch } from "./onlineDeathmatch.js?v=20260530b";
