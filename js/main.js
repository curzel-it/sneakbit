...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260527";
import { loadAssets } from "./assets.js?v=20260527";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260527";
import { loadStringsData, tr } from "./strings.js?v=20260527";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260527";
import { installInteract, tickInteract } from "./interact.js?v=20260527";
import { loadSpeciesData } from "./species.js?v=20260527";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260527";
import { buildZone, isWalkable, isEntityBlocked } from "./zone.js?v=20260527";
import { initInput, pollInput } from "./input.js?v=20260527";
import { createPlayer, updatePlayer } from "./player.js?v=20260527";
import { createCamera, updateCamera } from "./camera.js?v=20260527";
import { createRenderer, render } from "./renderer.js?v=20260527";
import { startGameLoop } from "./gameLoop.js?v=20260527";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260527";
import { tickEntities } from "./entities.js?v=20260527";
import { installAutoZoom } from "./zoom.js?v=20260527";
import { installHud, updateHud } from "./hud.js?v=20260527";
import { loadAudio } from "./audio.js?v=20260527";
import { loadSettings, getSettings } from "./settings.js?v=20260527";
import { installMenu, isMenuOpen } from "./menu.js?v=20260527";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260527";
import { checkPickup } from "./pickups.js?v=20260527";
import { installMusic, playTrack } from "./music.js?v=20260527";
import { installTouchControls } from "./touch.js?v=20260527";
import { installToast, showToast } from "./toast.js?v=20260527";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260527";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260527";
import { setGamepadAction } from "./gamepad.js?v=20260527";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260527";
import { tickMobs } from "./mobs.js?v=20260527";
import { tickMonsterFusion } from "./monsters.js?v=20260527";
import { tickMinionSpawning } from "./minions.js?v=20260527";
import { tickCombat } from "./combat.js?v=20260527";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260527";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260527";
import { installHealthHud } from "./healthHud.js?v=20260527";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260527";
import { installMessage, isMessageOpen } from "./message.js?v=20260527";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260527";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260527";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260527";
import { getZoneCache } from "./zoneCache.js?v=20260527";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260527";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260527";
import { tickTrails } from "./trails.js?v=20260527";
import { tickPushables } from "./pushables.js?v=20260527";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260527";
import { isCoopMode } from "./coopMode.js?v=20260527";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260527";
import { runMigrations } from "./migrations.js?v=20260527";
import { installMapEditor } from "./mapEditor.js?v=20260527";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260527";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead } from "./mirrorWorld.js?v=20260527";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260527";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260527";
import { installPartyPanel } from "./partyPanel.js?v=20260527";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260527";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260527";
