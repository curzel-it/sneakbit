...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260530c";
import { loadAssets } from "./assets.js?v=20260530c";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260530c";
import { loadStringsData, tr } from "./strings.js?v=20260530c";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260530c";
import { installInteract, tickInteract, tryInteractForSlot } from "./interact.js?v=20260530c";
import { loadSpeciesData } from "./species.js?v=20260530c";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260530c";
import { buildZone } from "./zone.js?v=20260530c";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260530c";
import { initInput, pollInput, clearInputState, clearInputHeld, pushInputPress } from "./input.js?v=20260530c";
import { createPlayer, updatePlayer } from "./player.js?v=20260530c";
import { createCamera, updateCamera, panCameraTo, cameraRectFor } from "./camera.js?v=20260530c";
import { createRenderer, render } from "./renderer.js?v=20260530c";
import { startGameLoop } from "./gameLoop.js?v=20260530c";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260530c";
import { tickEntities } from "./entities.js?v=20260530c";
import { installAutoZoom } from "./zoom.js?v=20260530c";
import { installHud, updateHud } from "./hud.js?v=20260530c";
import { loadAudio } from "./audio.js?v=20260530c";
import { loadSettings, getSettings, resolveLanguage } from "./settings.js?v=20260530c";
import { installMenu, isMenuOpen } from "./menu.js?v=20260530c";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260530c";
import { checkPickup } from "./pickups.js?v=20260530c";
import { installMusic, playTrack } from "./music.js?v=20260530c";
import { installTouchControls } from "./touch.js?v=20260530c";
import { installToast, showToast } from "./toast.js?v=20260530c";
import { installShooting, tickShooting, tryShoot, tryShootForSlot } from "./shooting.js?v=20260530c";
import { installMelee, tickMelee, tryMelee, tryMeleeForSlot } from "./melee.js?v=20260530c";
import { setGamepadAction } from "./gamepad.js?v=20260530c";
import { pollGuestGamepad } from "./guestInputForwarder.js?v=20260530c";
import { installActiveInputDevice } from "./activeInputDevice.js?v=20260530c";
import { installControllerPresence, isControllerPaused } from "./controllerPresence.js?v=20260530c";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260530c";
import { tickMobs } from "./mobs.js?v=20260530c";
import { tickMonsterFusion } from "./monsters.js?v=20260530c";
import { tickMinionSpawning } from "./minions.js?v=20260530c";
import { tickCombat } from "./combat.js?v=20260530c";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260530c";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260530c";
import { installHealthHud, refreshHealthHud } from "./healthHud.js?v=20260530c";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260530c";
import { installMessage, isMessageOpen } from "./message.js?v=20260530c";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260530c";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260530c";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260530c";
import { getZoneCache } from "./zoneCache.js?v=20260530c";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260530c";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260530c";
import { tickTrails } from "./trails.js?v=20260530c";
import { tickPushables } from "./pushables.js?v=20260530c";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260530c";
import { isCoopMode, setCoopMode, setLocalPlayerCount, localPlayerCount } from "./coopMode.js?v=20260530c";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260530c";
import { runMigrations } from "./migrations.js?v=20260530c";
import { installMapEditor } from "./mapEditor.js?v=20260530c";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260530c";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260530c";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260530c";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260530c";
import { installPartyPanel, isPartyPanelOpen } from "./partyPanel.js?v=20260530c";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260530c";
import { setHostPaused } from "./hostPauseState.js?v=20260530c";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260530c";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260530c";
import { installUiTokens } from "./uiTokens.js?v=20260530c";
import { isPvp, isTurnBasedPvp, isRealtimePvp } from "./gameMode.js?v=20260530c";
import { getTurn, isMatchOver } from "./pvpMatch.js?v=20260530c";
import { installTurnHud, updateTurnHud, hideTurnHud } from "./turnHud.js?v=20260530c";
import {
  installPvpController, pvpGateInput, pvpCameraTarget, tickPvpFrame,
} from "./pvpController.js?v=20260530c";
import { installOnlineDeathmatch, tickHostFrame as tickOnlineDeathmatch } from "./onlineDeathmatch.js?v=20260530c";
