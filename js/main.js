...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260529b";
import { loadAssets } from "./assets.js?v=20260529b";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260529b";
import { loadStringsData, tr } from "./strings.js?v=20260529b";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260529b";
import { installInteract, tickInteract } from "./interact.js?v=20260529b";
import { loadSpeciesData } from "./species.js?v=20260529b";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260529b";
import { buildZone } from "./zone.js?v=20260529b";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260529b";
import { initInput, pollInput } from "./input.js?v=20260529b";
import { createPlayer, updatePlayer } from "./player.js?v=20260529b";
import { createCamera, updateCamera } from "./camera.js?v=20260529b";
import { createRenderer, render } from "./renderer.js?v=20260529b";
import { startGameLoop } from "./gameLoop.js?v=20260529b";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260529b";
import { tickEntities } from "./entities.js?v=20260529b";
import { installAutoZoom } from "./zoom.js?v=20260529b";
import { installHud, updateHud } from "./hud.js?v=20260529b";
import { loadAudio } from "./audio.js?v=20260529b";
import { loadSettings, getSettings } from "./settings.js?v=20260529b";
import { installMenu, isMenuOpen } from "./menu.js?v=20260529b";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260529b";
import { checkPickup } from "./pickups.js?v=20260529b";
import { installMusic, playTrack } from "./music.js?v=20260529b";
import { installTouchControls } from "./touch.js?v=20260529b";
import { installToast, showToast } from "./toast.js?v=20260529b";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260529b";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260529b";
import { setGamepadAction } from "./gamepad.js?v=20260529b";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260529b";
import { tickMobs } from "./mobs.js?v=20260529b";
import { tickMonsterFusion } from "./monsters.js?v=20260529b";
import { tickMinionSpawning } from "./minions.js?v=20260529b";
import { tickCombat } from "./combat.js?v=20260529b";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260529b";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260529b";
import { installHealthHud } from "./healthHud.js?v=20260529b";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260529b";
import { installMessage, isMessageOpen } from "./message.js?v=20260529b";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260529b";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260529b";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260529b";
import { getZoneCache } from "./zoneCache.js?v=20260529b";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260529b";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260529b";
import { tickTrails } from "./trails.js?v=20260529b";
import { tickPushables } from "./pushables.js?v=20260529b";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260529b";
import { isCoopMode, setCoopMode } from "./coopMode.js?v=20260529b";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260529b";
import { runMigrations } from "./migrations.js?v=20260529b";
import { installMapEditor } from "./mapEditor.js?v=20260529b";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260529b";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260529b";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260529b";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260529b";
import { installPartyPanel } from "./partyPanel.js?v=20260529b";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260529b";
import { setHostPaused } from "./hostPauseState.js?v=20260529b";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260529b";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260529b";
import { installUiTokens } from "./uiTokens.js?v=20260529b";
