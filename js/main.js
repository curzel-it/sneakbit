...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260528h";
import { loadAssets } from "./assets.js?v=20260528h";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260528h";
import { loadStringsData, tr } from "./strings.js?v=20260528h";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260528h";
import { installInteract, tickInteract } from "./interact.js?v=20260528h";
import { loadSpeciesData } from "./species.js?v=20260528h";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260528h";
import { buildZone } from "./zone.js?v=20260528h";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260528h";
import { initInput, pollInput } from "./input.js?v=20260528h";
import { createPlayer, updatePlayer } from "./player.js?v=20260528h";
import { createCamera, updateCamera } from "./camera.js?v=20260528h";
import { createRenderer, render } from "./renderer.js?v=20260528h";
import { startGameLoop } from "./gameLoop.js?v=20260528h";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260528h";
import { tickEntities } from "./entities.js?v=20260528h";
import { installAutoZoom } from "./zoom.js?v=20260528h";
import { installHud, updateHud } from "./hud.js?v=20260528h";
import { loadAudio } from "./audio.js?v=20260528h";
import { loadSettings, getSettings } from "./settings.js?v=20260528h";
import { installMenu, isMenuOpen } from "./menu.js?v=20260528h";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260528h";
import { checkPickup } from "./pickups.js?v=20260528h";
import { installMusic, playTrack } from "./music.js?v=20260528h";
import { installTouchControls } from "./touch.js?v=20260528h";
import { installToast, showToast } from "./toast.js?v=20260528h";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260528h";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260528h";
import { setGamepadAction } from "./gamepad.js?v=20260528h";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260528h";
import { tickMobs } from "./mobs.js?v=20260528h";
import { tickMonsterFusion } from "./monsters.js?v=20260528h";
import { tickMinionSpawning } from "./minions.js?v=20260528h";
import { tickCombat } from "./combat.js?v=20260528h";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260528h";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260528h";
import { installHealthHud } from "./healthHud.js?v=20260528h";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260528h";
import { installMessage, isMessageOpen } from "./message.js?v=20260528h";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260528h";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260528h";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260528h";
import { getZoneCache } from "./zoneCache.js?v=20260528h";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260528h";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260528h";
import { tickTrails } from "./trails.js?v=20260528h";
import { tickPushables } from "./pushables.js?v=20260528h";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260528h";
import { isCoopMode, setCoopMode } from "./coopMode.js?v=20260528h";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260528h";
import { runMigrations } from "./migrations.js?v=20260528h";
import { installMapEditor } from "./mapEditor.js?v=20260528h";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260528h";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260528h";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260528h";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260528h";
import { installPartyPanel } from "./partyPanel.js?v=20260528h";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260528h";
import { setHostPaused } from "./hostPauseState.js?v=20260528h";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260528h";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260528h";
import { installUiTokens } from "./uiTokens.js?v=20260528h";
