...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260529c";
import { loadAssets } from "./assets.js?v=20260529c";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260529c";
import { loadStringsData, tr } from "./strings.js?v=20260529c";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260529c";
import { installInteract, tickInteract } from "./interact.js?v=20260529c";
import { loadSpeciesData } from "./species.js?v=20260529c";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260529c";
import { buildZone } from "./zone.js?v=20260529c";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260529c";
import { initInput, pollInput } from "./input.js?v=20260529c";
import { createPlayer, updatePlayer } from "./player.js?v=20260529c";
import { createCamera, updateCamera } from "./camera.js?v=20260529c";
import { createRenderer, render } from "./renderer.js?v=20260529c";
import { startGameLoop } from "./gameLoop.js?v=20260529c";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260529c";
import { tickEntities } from "./entities.js?v=20260529c";
import { installAutoZoom } from "./zoom.js?v=20260529c";
import { installHud, updateHud } from "./hud.js?v=20260529c";
import { loadAudio } from "./audio.js?v=20260529c";
import { loadSettings, getSettings } from "./settings.js?v=20260529c";
import { installMenu, isMenuOpen } from "./menu.js?v=20260529c";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260529c";
import { checkPickup } from "./pickups.js?v=20260529c";
import { installMusic, playTrack } from "./music.js?v=20260529c";
import { installTouchControls } from "./touch.js?v=20260529c";
import { installToast, showToast } from "./toast.js?v=20260529c";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260529c";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260529c";
import { setGamepadAction } from "./gamepad.js?v=20260529c";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260529c";
import { tickMobs } from "./mobs.js?v=20260529c";
import { tickMonsterFusion } from "./monsters.js?v=20260529c";
import { tickMinionSpawning } from "./minions.js?v=20260529c";
import { tickCombat } from "./combat.js?v=20260529c";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260529c";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260529c";
import { installHealthHud } from "./healthHud.js?v=20260529c";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260529c";
import { installMessage, isMessageOpen } from "./message.js?v=20260529c";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260529c";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260529c";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260529c";
import { getZoneCache } from "./zoneCache.js?v=20260529c";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260529c";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260529c";
import { tickTrails } from "./trails.js?v=20260529c";
import { tickPushables } from "./pushables.js?v=20260529c";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260529c";
import { isCoopMode, setCoopMode } from "./coopMode.js?v=20260529c";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260529c";
import { runMigrations } from "./migrations.js?v=20260529c";
import { installMapEditor } from "./mapEditor.js?v=20260529c";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260529c";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260529c";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260529c";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260529c";
import { installPartyPanel } from "./partyPanel.js?v=20260529c";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260529c";
import { setHostPaused } from "./hostPauseState.js?v=20260529c";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260529c";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260529c";
import { installUiTokens } from "./uiTokens.js?v=20260529c";
