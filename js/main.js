...
import { STARTING_ZONE_ID, STARTING_SPAWN } from "./constants.js?v=20260528i";
import { loadAssets } from "./assets.js?v=20260528i";
import { loadSpecies, loadStrings, loadZone } from "./data.js?v=20260528i";
import { loadStringsData, tr } from "./strings.js?v=20260528i";
import { installDialogue, isDialogueOpen } from "./dialogue.js?v=20260528i";
import { installInteract, tickInteract } from "./interact.js?v=20260528i";
import { loadSpeciesData } from "./species.js?v=20260528i";
import { composeBiomeSheet } from "./biomeSheet.js?v=20260528i";
import { buildZone } from "./zone.js?v=20260528i";
import { pickCoopSpawn } from "./coopSpawn.js?v=20260528i";
import { initInput, pollInput } from "./input.js?v=20260528i";
import { createPlayer, updatePlayer } from "./player.js?v=20260528i";
import { createCamera, updateCamera } from "./camera.js?v=20260528i";
import { createRenderer, render } from "./renderer.js?v=20260528i";
import { startGameLoop } from "./gameLoop.js?v=20260528i";
import { createBiomeAnimation, tickBiomeAnimation } from "./biomeAnimation.js?v=20260528i";
import { tickEntities } from "./entities.js?v=20260528i";
import { installAutoZoom } from "./zoom.js?v=20260528i";
import { installHud, updateHud } from "./hud.js?v=20260528i";
import { loadAudio } from "./audio.js?v=20260528i";
import { loadSettings, getSettings } from "./settings.js?v=20260528i";
import { installMenu, isMenuOpen } from "./menu.js?v=20260528i";
import { installTransitions, findTeleporterAt, travelTo } from "./transitions.js?v=20260528i";
import { checkPickup } from "./pickups.js?v=20260528i";
import { installMusic, playTrack } from "./music.js?v=20260528i";
import { installTouchControls } from "./touch.js?v=20260528i";
import { installToast, showToast } from "./toast.js?v=20260528i";
import { installShooting, tickShooting, tryShoot } from "./shooting.js?v=20260528i";
import { installMelee, tickMelee, tryMelee } from "./melee.js?v=20260528i";
import { setGamepadAction } from "./gamepad.js?v=20260528i";
import { installAmmoHud, updateAmmoHud } from "./ammoHud.js?v=20260528i";
import { tickMobs } from "./mobs.js?v=20260528i";
import { tickMonsterFusion } from "./monsters.js?v=20260528i";
import { tickMinionSpawning } from "./minions.js?v=20260528i";
import { tickCombat } from "./combat.js?v=20260528i";
import { tickAfterDialogue } from "./afterDialogue.js?v=20260528i";
import { tickPlayerHealth, isPlayerDead, resetPlayerHealth } from "./playerHealth.js?v=20260528i";
import { installHealthHud } from "./healthHud.js?v=20260528i";
import { installGameOver, isGameOverOpen, showGameOver } from "./gameOver.js?v=20260528i";
import { installMessage, isMessageOpen } from "./message.js?v=20260528i";
import { installFastTravel, isFastTravelOpen, tickFastTravel, markVisited } from "./fastTravel.js?v=20260528i";
import { applyFirstLaunch } from "./firstLaunch.js?v=20260528i";
import { loadProgress, saveProgress, clearProgress } from "./save.js?v=20260528i";
import { getZoneCache } from "./zoneCache.js?v=20260528i";
import { setupPuzzles, tickPuzzles } from "./puzzles.js?v=20260528i";
import { setupCutscenes, tickCutscenes } from "./cutscenes.js?v=20260528i";
import { tickTrails } from "./trails.js?v=20260528i";
import { tickPushables } from "./pushables.js?v=20260528i";
import { updateVisibleEntities } from "./zoneVisibility.js?v=20260528i";
import { isCoopMode, setCoopMode } from "./coopMode.js?v=20260528i";
import { showLoadingScreen, bumpLoadingProgress, hideLoadingScreen } from "./loadingScreen.js?v=20260528i";
import { runMigrations } from "./migrations.js?v=20260528i";
import { installMapEditor } from "./mapEditor.js?v=20260528i";
import { bootstrapOnline, onAnyClose } from "./onlineBootstrap.js?v=20260528i";
import { getMirrorZone, getMirrorPlayers, isMirrorReady, isMirrorDead, refreshMirrorEntities } from "./mirrorWorld.js?v=20260528i";
import { tickPredictedSelf, getPredictedSelf } from "./predictedSelf.js?v=20260528i";
import { getSelfPlayerId } from "./onlineBootstrap.js?v=20260528i";
import { installPartyPanel } from "./partyPanel.js?v=20260528i";
import { installHostLaggingOverlay, updateHostLaggingOverlay } from "./hostLaggingOverlay.js?v=20260528i";
import { setHostPaused } from "./hostPauseState.js?v=20260528i";
import { getRuntimeRole, getMode, getJoinCode, setRuntimeRole } from "./onlineMode.js?v=20260528i";
import { switchRole, setStateHandlers } from "./switchRole.js?v=20260528i";
import { installUiTokens } from "./uiTokens.js?v=20260528i";
