...
import { getNet, getNetRole, getSelfPlayerId } from "./onlineBootstrap.js?v=20260528h";
import { getPlayerHp } from "./playerHealth.js?v=20260528h";
import { getLastSeqMap } from "./hostGuests.js?v=20260528h";
