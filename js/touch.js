...
import { tryShoot } from "./shooting.js?v=20260530f";
import { tryMelee } from "./melee.js?v=20260530f";
import { getEquipped, onEquipmentChange, SLOT_MELEE } from "./equipment.js?v=20260530f";
import { getNetRole } from "./onlineBootstrap.js?v=20260530f";
import { codesFor } from "./keyBindings.js?v=20260530f";
import { onActiveInputDeviceChange } from "./activeInputDevice.js?v=20260530f";
