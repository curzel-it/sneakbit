...
import { tryShoot } from "./shooting.js?v=20260530e";
import { tryMelee } from "./melee.js?v=20260530e";
import { getEquipped, onEquipmentChange, SLOT_MELEE } from "./equipment.js?v=20260530e";
import { getNetRole } from "./onlineBootstrap.js?v=20260530e";
import { codesFor } from "./keyBindings.js?v=20260530e";
import { onActiveInputDeviceChange } from "./activeInputDevice.js?v=20260530e";
