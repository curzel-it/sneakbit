...
import { tryShoot } from "./shooting.js?v=20260530d";
import { tryMelee } from "./melee.js?v=20260530d";
import { getEquipped, onEquipmentChange, SLOT_MELEE } from "./equipment.js?v=20260530d";
import { getNetRole } from "./onlineBootstrap.js?v=20260530d";
import { codesFor } from "./keyBindings.js?v=20260530d";
import { onActiveInputDeviceChange } from "./activeInputDevice.js?v=20260530d";
