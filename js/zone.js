...
import { biomeFromChar, biomeIsObstacle, BIOME, isSlippery } from "./biomes.js?v=20260530f";
import { constructionFromChar, constructionIsObstacle, constructionIsBridge, constructionIsVisible, CONSTRUCTION } from "./constructions.js?v=20260530f";
import { biomeTextureCol } from "./biomeTiles.js?v=20260530f";
import { constructionTextureRow } from "./constructionTiles.js?v=20260530f";
import { getSpecies } from "./species.js?v=20260530f";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "./entityVisibility.js?v=20260530f";
