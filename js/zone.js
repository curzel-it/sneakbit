...
import { biomeFromChar, biomeIsObstacle, BIOME, isSlippery } from "./biomes.js?v=20260528h";
import { constructionFromChar, constructionIsObstacle, constructionIsBridge, constructionIsVisible, CONSTRUCTION } from "./constructions.js?v=20260528h";
import { biomeTextureCol } from "./biomeTiles.js?v=20260528h";
import { constructionTextureRow } from "./constructionTiles.js?v=20260528h";
import { getSpecies } from "./species.js?v=20260528h";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "./entityVisibility.js?v=20260528h";
