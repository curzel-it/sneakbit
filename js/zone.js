...
import { biomeFromChar, biomeIsObstacle, BIOME, isSlippery } from "./biomes.js?v=20260530g";
import { constructionFromChar, constructionIsObstacle, constructionIsBridge, constructionIsVisible, CONSTRUCTION } from "./constructions.js?v=20260530g";
import { biomeTextureCol } from "./biomeTiles.js?v=20260530g";
import { constructionTextureRow } from "./constructionTiles.js?v=20260530g";
import { getSpecies } from "./species.js?v=20260530g";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "./entityVisibility.js?v=20260530g";
