...
import { biomeFromChar, biomeIsObstacle, BIOME, isSlippery } from "./biomes.js?v=20260529e";
import { constructionFromChar, constructionIsObstacle, constructionIsBridge, constructionIsVisible, CONSTRUCTION } from "./constructions.js?v=20260529e";
import { biomeTextureCol } from "./biomeTiles.js?v=20260529e";
import { constructionTextureRow } from "./constructionTiles.js?v=20260529e";
import { getSpecies } from "./species.js?v=20260529e";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "./entityVisibility.js?v=20260529e";
