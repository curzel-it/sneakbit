...
import { biomeFromChar, biomeIsObstacle, BIOME, isSlippery } from "./biomes.js?v=20260531a";
import { constructionFromChar, constructionIsObstacle, constructionIsBridge, constructionIsVisible, CONSTRUCTION } from "./constructions.js?v=20260531a";
import { biomeTextureCol } from "./biomeTiles.js?v=20260531a";
import { constructionTextureRow } from "./constructionTiles.js?v=20260531a";
import { getSpecies } from "./species.js?v=20260531a";
import { shouldBeVisible, entityHittableFrame, rectOverlapsTile } from "./entityVisibility.js?v=20260531a";
