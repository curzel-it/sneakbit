...
import { resolveEntityDialogue, dialogueLines } from "./dialogue.js?v=20260528f";
...
import { addAmmo, getAmmo } from "./inventory.js?v=20260528f";
import { getValue, setValue } from "./storage.js?v=20260528f";
import { setEquipped, SLOT_MELEE, SLOT_RANGED } from "./equipment.js?v=20260528f";
import {
  setSessionLoadout,
  getSessionLoadout,
} from "./sessionLoadouts.js?v=20260528f";
...
import { isPlayerDead } from "./playerHealth.js?v=20260528f";
