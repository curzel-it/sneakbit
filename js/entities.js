...
import { TILE_SIZE, ANIMATIONS_FPS } from "./constants.js?v=20260530a";
import { getEntitySheet, getSpecies } from "./species.js?v=20260530a";
import { getSprite } from "./assets.js?v=20260530a";
import { getPlayerSpriteFrame } from "./player.js?v=20260530a";
import { SLOT_MELEE, SLOT_RANGED } from "./equipment.js?v=20260530a";
import { resolveLoadout } from "./sessionLoadouts.js?v=20260530a";
import { getMeleeSwingProgress } from "./melee.js?v=20260530a";
import { pushableRenderOffset } from "./pushables.js?v=20260530a";
import { shouldBeVisible } from "./entityVisibility.js?v=20260530a";
import { isCreativeMode } from "./creativeMode.js?v=20260530a";
import { isDying, DEATH_SPRITE } from "./deathAnimation.js?v=20260530a";
