...
import { getEntitySheet, getSpecies } from "./species.js?v=20260530g";
import { getSprite } from "./assets.js?v=20260530g";
import { getPlayerSpriteFrame } from "./player.js?v=20260530g";
import { SLOT_MELEE, SLOT_RANGED } from "./equipment.js?v=20260530g";
import { resolveLoadout } from "./sessionLoadouts.js?v=20260530g";
import { getMeleeSwingProgress } from "./melee.js?v=20260530g";
import { pushableRenderOffset } from "./pushables.js?v=20260530g";
import { shouldBeVisible } from "./entityVisibility.js?v=20260530g";
import { isCreativeMode } from "./creativeMode.js?v=20260530g";
import { isDying, DEATH_SPRITE } from "./deathAnimation.js?v=20260530g";
